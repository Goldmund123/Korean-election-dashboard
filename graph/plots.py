...
def update_scatter(x_col, y_col):
    ...
    fig.update_layout(legend=dict(xanchor='center', yanchor='top', x=0.45, y=-0.15))
    fig.update_layout(legend_title_text='', legend_orientation="h")
...
def update_histograms(x_col, y_col):
    ...
    fig1.update_layout(legend=dict(xanchor='left', yanchor='top', x=0.0, y=-0.5))
    fig1.update_layout(legend_title_text='', legend_orientation="h")
    ...
    fig2.update_layout(legend=dict(xanchor='left', yanchor='top', x=0.0, y=-0.5))
    fig2.update_layout(legend_title_text='', legend_orientation="h")
